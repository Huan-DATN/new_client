		...
		<div className="flex flex-col w-full bg-gray-50">
			...
			<div className="w-full bg-gradient-to-r from-green-50 to-blue-50 py-6">
				<div className="flex flex-row gap-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="w-1/3 rounded-xl overflow-hidden shadow-md flex flex-col gap-4">
						<HighlightCarousel />
						<HighlightCarousel />
					</div>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					<div className="bg-white p-6 rounded-xl shadow-sm flex flex-col items-center text-center">
						...
						<p className="text-gray-600">
							Tất cả sản phẩm đều được kiểm duyệt chất lượng trước khi đến tay
							khách hàng
						</p>
					</div>
					<div className="bg-white p-6 rounded-xl shadow-sm flex flex-col items-center text-center">
						...
						<p className="text-gray-600">
							Hệ thống giao hàng hiện đại giúp sản phẩm đến tay bạn trong thời
							gian ngắn nhất
						</p>
					</div>
					<div className="bg-white p-6 rounded-xl shadow-sm flex flex-col items-center text-center">
						...
						<p className="text-gray-600">
							Nhiều phương thức thanh toán đa dạng và bảo mật tuyệt đối
						</p>
					</div>
				</div>
			</div>
