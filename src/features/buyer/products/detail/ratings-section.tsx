		...
		<div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
			<Tabs defaultValue="ratings" className="w-full">
				<TabsList className="w-full bg-gray-50 border-b">
					<TabsTrigger value="ratings" className="flex items-center gap-1.5 data-[state=active]:bg-white">
						<Star className="h-4 w-4" />
						Đánh giá
					</TabsTrigger>
					<TabsTrigger value="comments" className="flex items-center gap-1.5 data-[state=active]:bg-white">
